    ...
    private ImageView getImageViewFromCache(int position, boolean isMultiImage) {
        ...
        mImageView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnItemClickListener != null) {
                    mOnItemClickListener.onItemClick(v, (Integer) v.getTag(R.id.FriendCircle_Position), PressX[0], PressY[0]);
                }
            }
        });
        mImageView.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if (mOnItemClickListener != null) {
                    mOnItemClickListener.onItemLongClick(v, (Integer) v.getTag(R.id.FriendCircle_Position), PressX[0], PressY[0]);
                }
                return true;
            }
        });
        mImageView.setId(url.hashCode());
        mImageView.setTag(R.id.FriendCircle_Position, position);
