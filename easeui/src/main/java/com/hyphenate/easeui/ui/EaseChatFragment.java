...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected int[] itemStrings = {R.string.attach_take_pic, R.string.attach_picture, R.string.attach_location,
            R.string.attach_file, R.string.attach_video_call, R.string.attach_video};
    protected int[] itemdrawables = {R.drawable.ease_chat_takepic_selector, R.drawable.ease_chat_image_selector,
            R.drawable.ease_chat_location_selector, R.drawable.em_chat_file_selector,
            R.drawable.em_chat_video_call_selector, R.drawable.em_chat_video_selector};
    protected int[] itemIds = {ITEM_TAKE_PICTURE, ITEM_PICTURE, ITEM_LOCATION, ITEM_FILE, ITEM_VIDEO_CALL, ITEM_VIDEO};
